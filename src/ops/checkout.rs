...
use crate::{items::TargetData, menu::arg::Arg, prompt::PromptData, state::State, Res};
...
fn checkout(state: &mut State, rev: &str) -> Res<()> {
...
fn checkout_new_branch_prompt_update(state: &mut State) -> Res<()> {
